...
<div style="display: flex; height: 100vh; align-items: stretch;">
  ...
  <div style="width: 45%; display: flex; justify-content: center; align-items: center;">
    <img src="part1sdg.png" style="max-height: 90vh; max-width: 100%; object-fit: contain;">
  </div>
...
<div style="display: flex; height: 100vh; align-items: stretch;">
  ...
  <div style="width: 50%; padding-right: 20px; box-sizing: border-box;">
    <h3 style="font-size: 24px;">Functional Modules & Visual Risk Mapping</h3>
    <ul>
      ...
      <li><strong>Real-time Alerts:</strong><br>
          push notifications for high-risk areas<br>
          display monitoring station water level change curves
      </li>
    </ul>
  ...
  <div style="width: 50%; display: flex; justify-content: center; align-items: center;">
    <img src="p3d5.png" style="max-height: 100vh; max-width: 96%; object-fit: contain;">
  </div>
...
<div style="text-align: center;">
  <img src="gfmPortalGif.gif" style="width: 90%;">
</div>
---
class: bg2
